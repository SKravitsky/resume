...
\headedsection  % sets the header for the section and includes any subsections
  ...
  \headedsubsection
    ...
    \item Containerized and rolled outall my applications to global Kubernetes clusters with Prometheus monitoring
    \item Led global roll-out and training on JIRA for entire Market Data team with custom documentation
    \item Managed JIRA instance for team of 60+ developers. Automated reporting to senior management with custom Python JIRA API to ensure OKR compliance and data hygiene
    \item Interviewed candidates for the firm with Coderpad on both Javascript and Python
    \end{itemize}}
}
...
\headedsection  % sets the header for the section and includes any subsections
  ...
  \headedsubsection
    ...
    {\begin{itemize}
    \item Developed site using ReactJS, ExpressJS, Redis, and Flask to help manage Bloombergs throughout the firm
